...
MASK_MODEL_PATH = (
    ...
    #"C:\College Project\Mask-Face-recog-Project-main\masksdetection\model\mask_model.h5"

    "C:\Final_year Project\Mask-Face-recog-Project-main (1)\Mask-Face-recog-Project-main\masksdetection\model\mask_model.h5"    

)

FACE_MODEL_PATH = (

    "C:\College Project\Mask-Face-recog-Project-main\masksdetection\face_detector"

)

SOUND_PATH = (

    "C:\College Project\Mask-Face-recog-Project-main\masksdetection\sounds\alarm.wav"
...
while True:
    ...
    for encodeFace, faceLoc, pred in zip(encodeCurFrame, facesCurFrame, preds):
        ...
        if name!='Unknown':
            mytext="ACCESS GRANTED"
            cv2.putText(img, mytext, (x1, y2+50 ), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2)
        else:
            mytext="ACCESS NOT GRANTED"
            cv2.putText(img, mytext, (x1 , y2 +50
